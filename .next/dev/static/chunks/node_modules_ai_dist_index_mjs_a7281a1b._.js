...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "6.0.27" : "TURBOPACK unreachable";
...
var doWrap3 = ({ model, middleware: { transformParams, wrapGenerate, overrideProvider, overrideModelId, overrideMaxImagesPerCall }, modelId, providerId })=>{
    ...
    const maxImagesPerCallRaw = (_a16 = overrideMaxImagesPerCall == null ? void 0 : overrideMaxImagesPerCall({
        model
    })) != null ? _a16 : model.maxImagesPerCall;
